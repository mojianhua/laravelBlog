            ...
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            <!-- <li>
                                <a onclick="xadmin.add_tab('统计页面','welcome1222.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>统计页面</cite></a>
                            </li> -->
                            <li>
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('用户添加','{{ url('Admin/user/create')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户添加</cite></a>
                            </li>
                           <!--  <li>
                            ...
                            <!-- <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a onclick="xadmin.add_tab('会员删除','member-del11.html')">
                                            <i class="iconfont">&#xe6a7;</i>
                                            <cite>会员删除</cite></a>
                                    </li>
                                    <li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('添加分类','{{ url('Admin/article/create')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加文章</cite></a>
                            </li>
                           <!--  <li>
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="网址配置管理">&#xe723;</i>
                            <cite>网站配置管理</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                            <!-- <li>
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('网站配置管理','{{ url('Admin/config') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>网站配置管理</cite></a>
                            </li>
                           <!--  <li>
